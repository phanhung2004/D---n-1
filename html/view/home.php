...
<main>
		...
		<div class="banner" style="height: 500px;">
			<!-- <img src="./img/banner/bannerhome5.jpg" alt="" width="100%" style="object-fit: cover; height: 500px;"> -->
			<div id="carouselExample" class="carousel slide">
  			<div class="carousel-inner">
					...
					<img src="./img/banner/bannerhome3.jpg" alt="" width="100%" style="object-fit: cover; height: 500px;">
					</div>
					<div class="carousel-item">
					<img src="./img/banner/bannerhome4.jpg" alt="" width="100%" style="object-fit: cover; height: 500px;">
					</div>
				</div>
