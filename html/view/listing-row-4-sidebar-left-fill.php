						...
						<form action="index.php?act=sanpham_fill" method="POST">
							...
							<div class="filter_type version_2">
								...
								<div class="collapse show" id="filter_1">
									<ul>
										<li>
											<label class="container_check">Áo phông
												<input type="checkbox" name="iddm[]" value="5">
												<span class="checkmark"></span>
											</label>
										</li>
										<li>
											<label class="container_check">Áo Sơ Mi
												<input type="checkbox" name="iddm[]" value="3">
												<span class="checkmark"></span>
											</label>
										</li>
										<li>
											<label class="container_check">Áo Polo
												<input type="checkbox" name="iddm[]" value="1">
												<span class="checkmark"></span>
											</label>
										</li>
							...
							<!-- /filter_type -->
							<div class="buttons">
								<input type="submit" name="fill" value="Fill" style="border-radius: 10px; background-color: blue; width: 100px; height: 35px; color: white; border: 1px none;">
							</div>
						</form>
	                </div>
	            </aside>	
